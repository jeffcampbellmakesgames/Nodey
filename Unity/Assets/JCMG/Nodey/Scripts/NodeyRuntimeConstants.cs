namespace JCMG.Nodey
{
	...
	public static class NodeyRuntimeConstants
	{
		// Exceptions
		...
		/// <summary> A collection of assembly prefixes that should not be reflected for derived node types. </summary>
		public static readonly string[] IGNORE_ASSEMBLY_PREFIXES =
		{
			"ExCSS",
			"Microsoft",
			"Mono",
